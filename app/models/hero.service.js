...
var HeroService = (function () {
    ...
    HeroService.prototype.createHero = function (hero) {
        return this.http.post(this.heroesUrl, hero).toPromise().then(function (response) { return response.json().data; }).catch(this.handleError);
    };
    HeroService.prototype.updateHero = function (hero) {
        var url = this.heroesUrl + "/" + hero.id;
        return this.http.put(url, hero).toPromise().then(function () { return hero; }).catch(this.handleError);
    };
    ;
    HeroService.prototype.deleteHero = function (id) {
        var url = this.heroesUrl + "/" + id;
        return this.http.delete(url).toPromise().then(function () { return null; }).catch(this.handleError);
    };
